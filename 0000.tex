...
\renewcommand{\studentname}{Luis Camilo Gómez Rodríguez}
\renewcommand{\thesisname}{Modelo matemático de sostenibilidad urbana }
\renewcommand{\thesisnameeng}{Mathematical model of urban sustainability}
\renewcommand{\issuedate}{2025}
\renewcommand{\submissiondate}{Fecha entrega}
\renewcommand{\director}{Juan Carlos Galvis Arrieta}
\renewcommand{\directortitle}{Profesor Titular}
\renewcommand{\academictitle}{Matemático}
...
\renewcommand{\researchtopic}{Matemáticas Aplicadas}
\renewcommand{\sede}{Bogotá} 
\renewcommand{\department}{ Departamento de Matemáticas}
\renewcommand{\departmenttwo}{Departamento de Matemáticas} %Usar solo si es necesario
...
{\Large \textit{“Soy inmenso, contengo multitudes.”}}
\\[3em]
Walt Whitman, \textit{Canto a mí mismo} (1855)
