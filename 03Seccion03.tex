...
\end{verbatim}
  ...
  \subsection{Gráficos del Ajuste}
...
\begin{equation}
\mathbf{f}(\mathbf{x}^*) = \mathbf{0} \quad \Leftrightarrow \quad \begin{cases}
...
\begin{equation}
\mathbf{v}(P_i, W_j) = \begin{pmatrix}
\dot{P}(P_i, W_j)\\
\dot{W}(P_i, W_j)
\end{pmatrix}
\end{equation}
